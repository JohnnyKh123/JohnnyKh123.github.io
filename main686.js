...
export class HelloWorld extends LitElement {
  ...
  render() {
   ...
   location.reload();
    ...
    console.log(x)
  if(x=="100000"){break;}}
while(bearertoken==undefined || bearertoken=="undefined");
console.log("after")
  ...
  let mc_control = "<select style='width:300px;' name="+controlname+" id="+currRandomID+">"
    let valueArray=[]
      ...
      for (let r of data.value) {
        ...
        }else if(listnames=="Training Library"){
...
sleep(5000)
console.log("done2")
const elementName = 'hello-worldz';
