          ...
          tab += `<div style ="margin: 10px 70px 70px;box-shadow: 0px 35px 50px rgba( 0, 0, 0, 0.2 );">
            ...
            col_items.forEach(function (field, i)
            {
              ...
              if(fieldVal!=="null" && fieldVal!==""){
                ...
                tab+=` <tr ><td style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"><label for="curr${r["Id"]}${i+1}" >`+Name(field)+`</label></td><td style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"><div style=" width:90%;border:none;" id=curr${r["Id"]}${i+1} value="${r[field]}" contenteditable="false">${r[field]}</div></td></tr>`
