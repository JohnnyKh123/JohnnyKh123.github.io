...
export class HelloWorld extends LitElement {
          ...
          tab += `<div style ="margin: 10px 70px 70px;box-shadow: 0px 35px 50px rgba( 0, 0, 0, 0.2 );">
            ...
            col_items.forEach(function (field, i)
            {
              ...
              if(field=="NonTechnicalTrainingCategory"){
                ...
                tab+=` <tr><td style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"><label for="curr${r["Id"]}${i+1}" >${field}</label></td><td id="NonTechnicalTrainingCategory${r["Id"]}${i+1}" style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"></td></tr>`
                fieldId=`NonTechnicalTrainingCategory${r["Id"]}${i+1}`;
                listName="TNA- Category";
               
              }else if(field=="NonTechnicalTrainingCategory1"){
                tab+=` <tr><td style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"><label for="curr${r["Id"]}${i+1}" >${field}</label></td><td id="NonTechnicalTrainingCategory1${r["Id"]}${i+1}" style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"></td></tr>`
                fieldId=`NonTechnicalTrainingCategory1${r["Id"]}${i+1}`;
                listName="TNA- Category";
                
              }else if(field=="NonTechnicalTrainingCompetency"){
                tab+=` <tr><td style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"><label for="curr${r["Id"]}${i+1}" >${field}</label></td><td id="NonTechnicalTrainingCompetency${r["Id"]}${i+1}" style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"></td></tr>`
                ...
                tab+=` <tr><td style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"><label for="curr${r["Id"]}${i+1}" >${field}</label></td><td id="NonTechnicalTrainingCompetency1${r["Id"]}${i+1}" style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"></td></tr>`
                fieldId=`NonTechnicalTrainingCompetency1${r["Id"]}${i+1}`;
                listName="TNA- Competency";    
                listFilter=`?$filter=Category eq '${currentCategory}'&?$filter=Title eq '${currentGrade}'`
                
              }else if(field=="NonTechnicalTrainingCourse"){
                tab+=` <tr><td style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"><label for="curr${r["Id"]}${i+1}" >${field}</label></td><td id="NonTechnicalTrainingCourse${r["Id"]}${i+1}" style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"></td></tr>`
                ...
                tab+=` <tr><td style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"><label for="curr${r["Id"]}${i+1}" >${field}</label></td><td id="NonTechnicalTrainingCourse1${r["Id"]}${i+1}" style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"></td></tr>`
                fieldId=`NonTechnicalTrainingCourse1${r["Id"]}${i+1}`;
                listName="Training Courses - TNA";    
                listFilter=`?$filter=Title eq '${currentCategory}'&?$filter=Competancy eq'${currentCompetency}'`
                
              }else{
                tab+=` <tr ><td style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"><label for="curr${r["Id"]}${i+1}" >${field}</label></td><td style="text-align: left;border: 1px solid #bac6c3;padding: 8px;"><div style=" width:90%;border:none;" id=curr${r["Id"]}${i+1} value="${r[field]}" contenteditable="false">${r[field]}</div></td></tr>`
                listName="TNA- Category";
  ...
  let mc_control = "<select name="+controlname+" id="+currRandomID+">"
    let valueArray=[]
